                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($admin) ?> admin</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="admin/users"><span class="float-left">View Details</span>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-warning o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($mahasiswa) ?> mahasiswa</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($dosen) ?> dosen</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-danger o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($daftarkelas) ?> daftarkelas</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-danger o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($daftarmatakuliah) ?> daftarmatakuliah</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-success o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($jadwalkuliah) ?> jadwalkuliah</div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-3">
                        <div class="card text-white bg-primary o-hidden h-100">
                            <div class="card-body">
                                ...
                                <div class="mr-5"><?= count($jurusan) ?> jurusan</div>
                            </div>
